        ...
        <body>
            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm py-3 py-lg-0 px-3 px-lg-0">
                <a href="{{route('home')}}" class="navbar-brand ms-lg-5">
                    <h1 class="m-0 text-uppercase text-dark"><i class="bi bi-shop fs-1 text-primary me-3" style="color:green!important"></i>Pet Shop</h1>
                </a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        @guest
                        <a href="{{route('login')}}" class="nav-item nav-link btn btn-success text-white px-3">Login <i class="bi bi-arrow-right"></i></a>
                        @endguest
                    </div>
                </div>
            </nav>
